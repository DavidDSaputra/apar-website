...
<head>
    ...
    <title>Login - APAR Indonesia</title>
...
<body class="font-sans min-h-screen flex items-center justify-center relative overflow-hidden"
    ...
    <button id="themeToggle"
        class="theme-toggle-btn fixed top-6 right-6 p-3 theme-bg-secondary rounded-lg hover:bg-red-400/10 transition-all duration-300 z-50 animate-fade-in-down">
        <i class="fas fa-sun text-red-500 text-xl" id="lightIcon"></i>
        <i class="fas fa-moon text-red-500 text-xl hidden" id="darkIcon"></i>
    </button>
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <div class="flex items-center justify-center lg:justify-start space-x-3 mb-8">
                            <div
                                ...
                                <i class="fas fa-fire-extinguisher text-white text-3xl"></i>
                            </div>
                            <div>
                                <h1 class="text-4xl font-bold text-red-600">APAR Indonesia</h1>
                                <p class="text-sm theme-text-secondary">Solusi Proteksi Kebakaran Terpercaya</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-4 animate-fade-in-up delay-100">
                                ...
                                <div class="text-left">
                                    <h3 class="font-semibold theme-text-primary">Manajemen Inventori</h3>
                                    <p class="text-sm theme-text-secondary">Kelola stok APAR dan aksesoris</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-4 animate-fade-in-up delay-200">
                                ...
                                <div class="text-left">
                                    <h3 class="font-semibold theme-text-primary">Edukasi & Blog</h3>
                                    <p class="text-sm theme-text-secondary">Update tips keselamatan kebakaran</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-4 animate-fade-in-up delay-300">
                                ...
                                <div class="text-left">
                                    <h3 class="font-semibold theme-text-primary">Manajemen Admin</h3>
                                    <p class="text-sm theme-text-secondary">Kelola akses tim dan operasional</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-12 relative">
                            <div class="absolute inset-0 flex items-center justify-center">
                                <div class="w-32 h-32 bg-red-400/10 rounded-full animate-pulse-glow"></div>
                            </div>
                ...
                <div class="animate-slide-in-right">
                    <div
                        ...
                        <div class="lg:hidden flex items-center justify-center space-x-3 mb-8 animate-fade-in-down">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-red-600">APAR</h1>
                                <p class="text-xs theme-text-secondary">Indonesia</p>
                            </div>
                        </div>
                        ...
                        <form id="loginForm" class="space-y-6" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="animate-fade-in-up delay-100">
                                ...
                                <input type="email" name="email" id="email" placeholder="admin@example.com"
                                    class="input-field w-full px-4 py-3 theme-bg-secondary theme-border border rounded-lg focus:outline-none focus:border-red-500 theme-text-primary @error('email') border-red-500 @enderror"
                            ...
                            <div class="animate-fade-in-up delay-200">
                                ...
                                <div class="relative">
                                    <input type="password" name="password" id="password"
                                        ...
                                        class="input-field w-full px-4 py-3 theme-bg-secondary theme-border border rounded-lg focus:outline-none focus:border-red-500 theme-text-primary pr-12"
                                        required>
                                    <button type="button" id="togglePassword"
                                        class="absolute right-4 top-1/2 -translate-y-1/2 theme-text-secondary hover:text-red-500 transition-colors">
                            ...
                            <div class="flex items-center justify-between animate-fade-in-up delay-300">
                                <label class="flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" name="remember" id="remember"
                                        class="w-4 h-4 rounded border-2 theme-border bg-transparent checked:bg-red-500 checked:border-red-500 transition-all cursor-pointer">
    ...
    <script>
        ...
        if (btnPrimary) {
            btnPrimary.addEventListener('mouseenter', function () {
                this.style.boxShadow = '0 15px 30px rgba(239, 68, 68, 0.5)';
            });
