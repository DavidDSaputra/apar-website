...
@section('content')
    ...
    <div
        ...
        <div class="bg-white/5 px-6 py-4 theme-border border-b">
            <h2 class="text-xl font-bold theme-text-primary">Tambah Testimoni Baru</h2>
            <p class="text-sm theme-text-secondary mt-1">Isi form di bawah untuk menambahkan testimoni</p>
        </div>
