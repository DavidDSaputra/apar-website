...
@section('content')
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 animate-fade-in-up">
            <h1 class="text-2xl font-bold theme-text-primary">Edit Produk</h1>
        ...
        <div
            ...
            <div class="p-6 theme-border border-b">
                <h2 class="text-lg font-semibold theme-text-primary">Form Edit Produk</h2>
            </div>
            ...
            <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs theme-text-secondary opacity-70">Biarkan kosong jika tidak ingin mengubah
                            </p>
                            @error('gambar_utama')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs theme-text-secondary opacity-70">Pilih beberapa gambar untuk ditambahkan
                                ke galeri</p>
                            @error('gambar_produk')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                ...
                @if($produk->gambar->count() > 0)
                    <div class="mt-8 pt-6 theme-border border-t">
                        <h3 class="text-lg font-semibold theme-text-primary mb-4">Galeri Produk Saat Ini</h3>
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                            @foreach($produk->gambar as $gambar)
                                <div class="relative group">
                                    <img src="{{ asset('storage/' . $gambar->nama_file) }}" alt="Gallery Image"
                                        class="w-full h-32 object-cover rounded-lg theme-border border">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3"
                                class="w-full px-4 py-2 theme-bg-secondary theme-border border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent theme-text-primary @error('meta_description') border-red-500 @enderror">{{ old('meta_description', $produk->meta_description) }}</textarea>
                            ...
                            @if($produk->og_image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $produk->og_image) }}" alt="OG Image"
                                        class="w-32 h-32 object-cover rounded-lg theme-border border">
                                </div>
                            @endif
