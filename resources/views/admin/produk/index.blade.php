    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6 animate-fade-in-up">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-red-400">Produk</h2>
                            ...
                            <tr class="hover:bg-red-400/5 transition duration-150">
                                    ...
                                    <div class="flex items-center">
                                        @if ($item->gambar_utama)
                                            <img src="{{ asset('storage/' . $item->gambar_utama) }}" alt="{{ $item->nama_produk }}"
                                                class="h-16 w-16 object-cover rounded-lg theme-border border ring-2 ring-red-400/30 mr-3">
                                        @else
                                            <div
                                                class="h-16 w-16 bg-gradient-to-br from-red-400 to-red-600 rounded-lg flex items-center justify-center mr-3">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if ($item->gambar->count() > 0)
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-500/10 text-red-400 border border-red-500/20">
                ...
                @forelse($produk as $item)
                    <div class="p-4 hover:bg-red-400/5 transition duration-150">
                        <div class="flex gap-4">
                            @if ($item->gambar_utama)
                                <img src="{{ asset('storage/' . $item->gambar_utama) }}" alt="{{ $item->nama_produk }}"
                                    class="h-20 w-20 object-cover rounded-lg theme-border border ring-2 ring-red-400/30 flex-shrink-0">
                            @else
                                <div
                                    class="h-20 w-20 bg-gradient-to-br from-red-400 to-red-600 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    @if ($item->gambar->count() > 0)
                                        <span
                                            class="px-2 py-1 text-xs font-medium rounded-full bg-red-500/10 text-red-400 border border-red-500/20">
